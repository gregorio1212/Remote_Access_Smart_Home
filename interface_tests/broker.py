...
MQTT_HOST = "192.168.0.3" #static IP I set to my raspberry pi the MQTT broker
MQTT_PORT = 9001
# ---------------------------------------
...
client = mqtt.Client(client_id="python-commander",transport='websockets')
...
while True:
    ...
    elif animate_msg == "test":
        client.publish("mcu/basement", payload=20, qos=0, retain=False)
    else:
        command_error()
